...
class BootStrap {
    ...
    def init = { servletContext ->
        if (!Role.findByAuthority("ROLE_ADMIN")) {
            User user1 = new User(username: "admin", password: "Admin@215").save(flush: true, failOnError: true)
            User user2 = new User(username: "parul", password: "Parul@215").save(flush: true, failOnError: true)
            Role role1 = new Role(authority: "ROLE_ADMIN").save(flush: true, failOnError: true)
